...
if(isset($_GET['id'])){
    ...
    $sql = "DELETE FROM contatos co WHERE "ID ".$_GET['id'];
}
...
<table>
    ...
    ?>
        <tr>
            ...
            ?>
            <td>
                <a href="?pg=contato/processar_formulario&id=<?= $linha["id"]?>">Editar</a>
            </td>
            <td>
                <a href="?pg=contato/processar_formulario&id=<?= $linha["id"]?>">Excluir</a>
            </td>
        </tr>
    <?php
        }
